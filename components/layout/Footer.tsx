        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <p className="text-gray-600 max-w-md">
              Your gateway to mastering the Arabic language. With structured courses, native instructors, and cultural insights, we make learning Arabic effective and engaging for all levels.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">ibrahimjamiuakeem@gmail.com</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">+234 817 959 5492</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="font-medium text-gray-900">Kwara, NIGERIA</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            ...
            <div className="text-center md:text-right">
              <p className="text-gray-600 text-sm flex items-center justify-center md:justify-end">
                <span>© {currentYear} Master Arabic. All rights reserved.</span>
                <Heart className="h-4 w-4 text-red-500 mx-1" fill="currentColor" />
                <span>For Arabic learners worldwide</span>
              </p>
              <p className="text-gray-500 text-xs mt-2">
                Version 2.0 • Made with passion for language learning
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-4">
                <div className="text-sm font-medium text-gray-700">Harvard University</div>
                <div className="text-sm font-medium text-gray-700">UNESCO</div>
                <div className="text-sm font-medium text-gray-700">Qatar Foundation</div>
                <div className="text-sm font-medium text-gray-700">Al Jazeera</div>
              </div>
            </div>
            <div className="text-sm text-gray-600">
              4.9 ★ Average rating from 5,000+ students
            </div>
          </div>
        </div>
      </div>
